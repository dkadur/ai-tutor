...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex gap-1 text-gray-800 cursor-pointer select-none items-center text-md rounded-sm px-3 py-1.5 font-medium outline-none focus:bg-secondary-100 data-[state=open]:bg-secondary-100",
      className,
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-md outline-none focus:bg-secondary-100 focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      className,
    )}
    {...props}
